...
class _FormularioPageState extends State<FormularioPage> {
  ...
  // variáveis booleanas para ocultar senha (uma para cada campo)
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: "Digite seu nome...", border: OutlineInputBorder()),
                ),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: "Digite seu email...", border: OutlineInputBorder()),
                ),
                const SizedBox(height: 10),
                ...
                TextFormField(
                  ...
                  obscureText: _senhaOculta, // mecanismo para mostrar senha oculta
                ...
                TextFormField(
                  validator: (value) => value == _senha ? null : "As senhas não coincidem",
                  onChanged: (value) => setState(() => _confirmarSenha = value),
                  obscureText: _confirmarSenhaOculta, // variável separada da senha
                  decoration: InputDecoration(
                    labelText: "Confirme sua senha...",
                    border: const OutlineInputBorder(),
                    suffixIcon: IconButton(
                      onPressed: () => setState(() => _confirmarSenhaOculta = !_confirmarSenhaOculta),
                      icon: Icon(_confirmarSenhaOculta ? Icons.visibility : Icons.visibility_off),
                    ),
                  ),
                ),
                SizedBox(height: 10,),
                ...
                Row(
                  children: [
                    ...
                    Expanded(child: Slider(
                      ...
                      min: 0,
                      max: 100,
                      divisions: 100, // quantidade de divisões do slider (intervalos de 1 em 1)
                      )
                      )
                  ],
                ),
