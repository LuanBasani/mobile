...
class _Exemplo1PageState extends State<Exemplo1Page> {
  ...
  //inicio da página
  @override // função padrão que vai ser reescrita para carregar as informações do SharedPreferences antes de buildar a tela pela 1º vez
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 10),
            Text("Nome do Usuário atual: $_nomeSalvo", style: TextStyle(fontSize: 20),),
            SizedBox(height: 20,),
